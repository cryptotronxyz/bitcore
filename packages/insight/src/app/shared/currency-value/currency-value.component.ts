...
export class CurrencyValueComponent implements OnChanges {
  ...
  amount: number;
  /**
   * The currency code/ticker symbol of the value. (E.g. when displaying a AUDAX
   * value from the Bitcore API, this should likely be `AUDAX_satoshis`, even if
   ...
   * unit in which to display the value. (E.g. `AUDAX_bits`, `AUDAX`, `USD`, etc.)
   *
